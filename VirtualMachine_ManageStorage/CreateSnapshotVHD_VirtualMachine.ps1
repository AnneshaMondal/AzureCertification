...
Use this script to import a specialized VHD to a snapshot and then use the snapshot to create multiple identical managed disks in a small amoutn of time.
Also, use it to import a data VHD to a snapshot and then use the snapshot to create multiple managed disks in small amount of time.
#>
