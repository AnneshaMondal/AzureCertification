...
It first generates the SAS URI of the snapshot and then uses it to copy it to storage account in a different region.
Use this script to maintain backup of your managed disks in a different region for disaster recovery. 
#>
