...
Use this script to import a specialized (not generalized/sysprepped) VHD to managed OS disk to crate a virtual machine.
It can also be used to import a data VHD to managed data disk.
#>
