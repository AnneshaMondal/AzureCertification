...
Use this script in the preceding scenarios: 
    Create a VM from an existing managed OS disk that was copied from a managed disk in different subscriptions
    Create a VM from an existing managed disk that was creatd from a specialized VHD file
