<#
This script creates an Azure Virtual Machine, installs the Log Analaytics agent, and enrolls the system with a Log Analytics workspace. 
Once the script has run, the virtual machine will be visible in Azure monitor. 
Also, you need to update the Log Analytics workspace ID and workspace key.
#>
